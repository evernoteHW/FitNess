...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withViewArray:(NSArray *)viewArray
{
    ...
    CGSize titleSize = [title sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:kTitleFont, NSFontAttributeName, nil]];
...
//        CGSize textSize = [string sizeWithFont:font];
     CGSize textSize = [string sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:font, NSFontAttributeName, nil]];
...
//    CLog(@"topPoint====>>>%f",topPoint.x);
//    CLog(@"topPoint====>>>%f",topPoint.y);
