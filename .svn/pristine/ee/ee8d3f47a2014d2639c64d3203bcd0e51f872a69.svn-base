...
- (void)initControlBtn {
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, DIME_SCREEN_H - 100 , 100, 50)];
    if (IOS_VERSION < 7.0) {
        cancelBtn.top = DIME_SCREEN_H - 70;
        if (DIME_SCREEN_H != 480) {
            cancelBtn.top = DIME_SCREEN_H - 100;
        }
    }
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 100.0f, DIME_SCREEN_H - 100, 100, 50)];
    if (IOS_VERSION < 7.0) {
        confirmBtn.top = DIME_SCREEN_H - 70;
        if (DIME_SCREEN_H != 480) {
            confirmBtn.top = DIME_SCREEN_H - 100;
        }
    }
